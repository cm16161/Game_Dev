...
pub struct GameboardViewSettings {
    ...
    /// Background colour for a selected cell
    pub selected_cell_background_colour: Color,
    /// Text Colour
...
impl GameboardViewSettings {
    ...
    pub fn new() -> GameboardViewSettings {
        GameboardViewSettings {
            ...
            selected_cell_background_colour: [0.9, 0.9, 1.0, 1.0],
            text_colour: [0.0, 0.0, 0.1, 1.0],
        }
    }
}
...
impl GameboardView {
        ...
        C: CharacterCache<Texture = G::Texture>,
    {
        ...
        if let Some(ind) = controller.selected_cell {
            ...
            Rectangle::new(settings.selected_cell_background_colour).draw(
                cell_rect,
                &c.draw_state,
                c.transform,
                g,
        ...
        // Draw Characters
        let text_image = Image::new_color(settings.text_colour);
        let cell_size = settings.size / 9.0;
        for j in 0..9 {
            for i in 0..9 {
